...
import com.eugene.hotelproj.controllers.UserRoleController;
...
privileged aspect UserRoleController_Roo_Controller {
    ...
    public String UserRoleController.show(@PathVariable("userRoleId") Long userRoleId, Model uiModel) {
    ...
    public String UserRoleController.updateForm(@PathVariable("userRoleId") Long userRoleId, Model uiModel) {
    ...
    public String UserRoleController.delete(@PathVariable("userRoleId") Long userRoleId, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
