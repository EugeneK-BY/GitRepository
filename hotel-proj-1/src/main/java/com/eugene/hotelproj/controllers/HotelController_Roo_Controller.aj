...
import com.eugene.hotelproj.controllers.HotelController;
...
privileged aspect HotelController_Roo_Controller {
    ...
    public String HotelController.create(@Valid HotelUser hotelUser, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String HotelController.update(@Valid HotelUser hotelUser, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, hotelUser);
    ...
    void HotelController.populateEditForm(Model uiModel, HotelUser hotelUser) {
